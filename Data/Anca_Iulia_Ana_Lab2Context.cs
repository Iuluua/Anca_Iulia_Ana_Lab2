...
namespace Anca_Iulia_Ana_Lab2.Data
{
    public class Anca_Iulia_Ana_Lab2Context : DbContext
    {
        ...
        public DbSet<Anca_Iulia_Ana_Lab2.Models.Author> Author { get; set; } = default!;
        public DbSet<Anca_Iulia_Ana_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Anca_Iulia_Ana_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Anca_Iulia_Ana_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
